...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION="%F{$purple}❯%f%F{$blue}❯%f%F{$white}❯%f"
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION="%F{$purple}❮%f%F{$blue}❮%f%F{$white}❮%f"
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION="%F{$purple}V%f%F{$blue}V%f%F{$white}V%f"
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION="%F{$purple}▶%f%F{$blue}▶%f%F{$white}▶%f"
