...
autocmd FileType c,cpp nnoremap <buffer> [f :%!clang-format --style=file<CR>
autocmd FileType c,cpp vnoremap <buffer> [f :!clang-format --style=file<CR>

" Find what error causes the red highlight
nnoremap [e :echo synIDattr(synID(line("."), col("."), 1), "name")<CR>
